...
import { R as Route$3, c as createServerFn, a as createServerRpc } from './ssr.mjs';
...
const SplitComponent = function Home() {
  ...
  const state = Route$3.useLoaderData();
...
//# sourceMappingURL=demo.start.server-funcs-j4kRFzJ2.mjs.map
